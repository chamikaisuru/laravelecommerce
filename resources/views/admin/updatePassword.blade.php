                ...
                <form action="{{ route('admin.updatePassword') }}" method="post">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input class="form-control" id="admin_email" name="admin_email" placeholder="Enter email" value="{{ Auth::guard('admin')->user()->email }}" readonly style="background-color:#666 " >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="confrim_pwd">Confirm Password</label>
                        <input type="password" class="form-control" name="confrim_pwd" id="confrim_pwd" placeholder="Confirm Password">
                      </div>
                  </div>
                  <!-- /.card-body -->
